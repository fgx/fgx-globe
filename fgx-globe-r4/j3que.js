// loads faster out here?!?
	...
	if ( location.hash === "" ) {
		link.setAttribute("href", "http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css");
	} else {
		var hashes = location.hash.split("#");
		link.setAttribute("href", "http://code.jquery.com/ui/1.10.3/themes/" + hashes[1].substr(9) + "/jquery-ui.css");
	}
